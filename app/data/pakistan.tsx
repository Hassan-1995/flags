export const pakistanShop = [
  {
    id: "1",
    imageSrc: "/images/products/Pakistan_Flag.png",
  ...
  {
    id: "2",
    imageSrc: "/images/products/Pakistan_Flag_Hard_Finish_With_Stand.png",
  ...
  {
    id: "3",
    imageSrc: "/images/products/Pakistan_Flag_Hard_Finish_Without_Stand.png",
    title: "Pakistan Flag Digital Printed Hard Finish – Without Stand",
    description: "Hard finish flag for display without base.",
    price: { min: 700, max: 14000 },
  },
  {
    id: "4",
    imageSrc: "/images/products/Pakistan_Table_Flag_Marble.png",
    title: "Pakistan Table Flag Stand Marble Base",
    description: "Elegant marble-based table flag.",
    price: { min: 600, max: 1100 },
  },
  {
    id: "5",
    imageSrc: "/images/products/Pakistan_Table_Flag_Steel.png",
