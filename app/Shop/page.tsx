  ...
  return (
    <div className="bg-zinc-100 scroll-smooth">
      <div className="flex flex-col justify-center items-center h-20">
        <h1 className="text-3xl font-bold text-green-400">VIP Flag Shop</h1>
        <h1 className="text-xl italic font-bold text-black">
          From Nations to Notions — We’ve Got Your Flag
        </h1>
      </div>
